...
-- 6 South African medical aid schemes
-- ============================================================================

SET search_path TO dwh, public;

-- Insert 6 South African medical aid schemes
...
-- Verify
SELECT COUNT(*) as insurance_count FROM dwh.dim_insurance;
SELECT provider_name, scheme_name, default_coverage_percentage FROM dwh.dim_insurance;